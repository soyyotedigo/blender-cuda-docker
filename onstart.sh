...
SCENE_REMOTE="${SCENE_REMOTE:-gdrive:escenas/test}"          # carpeta en Drive con la escena
SCENE_FILE="${SCENE_FILE:-escena.blend}"                     # archivo .blend
OUTPUT_REMOTE="${OUTPUT_REMOTE:-gdrive:renders/test}"        # carpeta en Drive para los renders
